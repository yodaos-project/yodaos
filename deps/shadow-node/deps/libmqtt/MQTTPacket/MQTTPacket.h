...
int MQTTPacket_decode(int (*getcharfn)(unsigned char*, int, void*), int* value, void*);
...
DLLExport int MQTTPacket_read(unsigned char* buf, int buflen, int (*getfn)(unsigned char*, int, void*), void*);
