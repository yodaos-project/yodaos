...
var theSyntaxError = new SyntaxError('Some syntax error');
var theRangeError = new RangeError('Some type error');
var theReferenceError = new ReferenceError('Some reference error');
var theURIError = new URIError('Some URI error');
var theEvalError = new EvalError('Some eval error');

class MyError extends Error { }
var myError = new MyError('Some MyError');
