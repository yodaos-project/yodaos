...
DEFAULT_PACKAGES:=base-files libc libgcc busybox mtd uci opkg netifd fstools uclient-fetch logd senseflow aicore
# For nas targets
DEFAULT_PACKAGES.nas:=block-mount fdisk lsblk mdadm
# For router targets
#DEFAULT_PACKAGES.router:=dnsmasq iptables ip6tables ppp ppp-mod-pppoe firewall odhcpd odhcp6c
DEFAULT_PACKAGES.router:=iptables ip6tables firewall odhcp6c kmod-rtl8192cu wireless-tools wpa-supplicant
...
__config_name_list = $(1)/config-$(KERNEL_PATCHVER) $(1)/config-default$(patsubst "%",%,$(CONFIG_subtarget_version))
