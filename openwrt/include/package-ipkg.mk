...
ifeq ($(PKG_INSTALL_STAMP),default.install)
          .PHONY: $(PKG_INFO_DIR)/$(1).$(PKG_INSTALL_STAMP).$(1)
          compile: $(PKG_INFO_DIR)/$(1).$(PKG_INSTALL_STAMP).$(1)
          $(PKG_INFO_DIR)/$(1).$(PKG_INSTALL_STAMP).$(1):
			if [ -f $(PKG_INFO_DIR)/$(1).$(PKG_INSTALL_STAMP).clean ]; then \
				rm -f \
					$(PKG_INFO_DIR)/$(1).$(PKG_INSTALL_STAMP) \
					$(PKG_INFO_DIR)/$(1).$(PKG_INSTALL_STAMP).clean; \
			fi; \
			echo "$(1)" >> $(PKG_INFO_DIR)/$(1).$(PKG_INSTALL_STAMP)
else
