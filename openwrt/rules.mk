...
TARGET_APP_DIR:=$(TARGET_ROOTFS_DIR)/root-app-$(BOARD)
  ...
  ifeq ($(CONFIG_EXTERNAL_TOOLCHAIN),)
    ...
    ifeq ($(CONFIG_NATIVE_TOOLCHAIN),)
	  ...
	  ifneq ($(CONFIG_EXTERNAL_KERNEL_TOOLCHAIN),)
		KERNEL_TOOLCHAIN_ROOT_DIR:=$(call qstrip,$(CONFIG_EXTERNAL_KERNEL_TOOLCHAIN_DIR))
		KERNEL_TOOLCHAIN_BIN_DIRS:=$(patsubst ./%,$(KERNEL_TOOLCHAIN_ROOT_DIR)/%,$(call qstrip,$(CONFIG_EXTERNAL_KERNEL_TOOLCHAIN_BIN_PATH)))
		KERNEL_TOOLCHAIN_INC_DIRS:=$(patsubst ./%,$(KERNEL_TOOLCHAIN_ROOT_DIR)/%,$(call qstrip,$(CONFIG_EXTERNAL_KERNEL_TOOLCHAIN_INC_PATH)))
		KERNEL_TOOLCHAIN_LIB_DIRS:=$(patsubst ./%,$(KERNEL_TOOLCHAIN_ROOT_DIR)/%,$(call qstrip,$(CONFIG_EXTERNAL_KERNEL_TOOLCHAIN_LIB_PATH)))
		KERNEL_TARGET_CROSS:=$(KERNEL_TOOLCHAIN_ROOT_DIR)/bin/$(call qstrip,$(CONFIG_EXTERNAL_KERNEL_TOOLCHAIN_PREFIX))
		KERNEL_TARGET_CC:=$(KERNEL_TARGET_CROSS)gcc
		KERNEL_TARGET_CXX:=$(KERNEL_TARGET_CROSS)g++
	   endif
    endif
  endif
endif
...
export PATH:=$(PATH):$(TOPDIR)/../toolchains/csky/bin
