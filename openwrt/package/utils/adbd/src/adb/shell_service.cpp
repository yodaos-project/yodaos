...
bool Subprocess::ForkAndExec(std::string* error) {
    ...
    if (pw != nullptr) {
        ...
        env["PATH"] = "/usr/sbin:/usr/bin:/sbin:/bin:/data/custom/usr/bin";
        env["LD_LIBRARY_PATH"] = "/usr/lib/:/usr/lib/hw:/lib:/data/custom/usr/lib";
        env["NODE_PATH"] = "/usr/lib/node_modules";
        env["PULSEAUDIO_HOME"] = "/var/run/pulse";
        env["NODE_PRIORITIZED_PATH"] = "/usr/lib/node_modules";
        env["HOME"] = pw->pw_dir;
