...
define KernelPackage/gadget-fs
  TITLE:=support gadget fs
  KCONFIG:=CONFIG_USB_FUNCTIONFS
  FILES:= \
	$(LINUX_DIR)/drivers/usb/gadget/legacy/g_ffs.ko
  AUTOLOAD:=$(call AutoLoad,04)
  $(call AddDepends/usb)
endef

define KernelPackage/gadget-fs/description
 Kernel modules for gadget fs
endef

$(eval $(call KernelPackage,gadget-fs))
