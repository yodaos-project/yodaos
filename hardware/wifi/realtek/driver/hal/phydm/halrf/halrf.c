...
void halrf_dpk_trigger(void *dm_void, u8 group)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	struct _hal_rf_ *rf = &dm->rf_table;
	...
	case ODM_RTL8197F:
#if 0
		/*do_dpk_8197f(dm, true, group);*/
#endif
		break;
#endif
#if (RTL8192F_SUPPORT == 1)
	case ODM_RTL8192F:
		do_dpk_8192f(dm, true, group);
		break;
#endif
	...
	RF_DBG(dm, DBG_RF_IQK, "[DPK]DPK progressing_time = %lld ms\n",
	       rf->dpk_progressing_time);
}

void halrf_dpk_enable_disable(void *dm_void, boolean is_enable)
{
	struct dm_struct *dm = (struct dm_struct *)dm_void;
	...
	case ODM_RTL8197F:
#if 0
		/*phy_dpk_enable_disable_8197f(dm, is_enable);*/
#endif
		break;
#endif
#if (RTL8192F_SUPPORT == 1)
	case ODM_RTL8192F:
		phy_dpk_enable_disable_8192f(dm, is_enable);
		break;
#endif
