...
u8 phy_path_s1_iqk_8723d(struct dm_struct *dm, boolean config_path_s0)
{
	...
	/*path-A IQK setting*/
	odm_set_bb_reg(dm, REG_TX_IQK_TONE_A, MASKDWORD, 0x08008c0c);
	odm_set_bb_reg(dm, REG_RX_IQK_TONE_A, MASKDWORD, 0x38008c1c);
	odm_set_bb_reg(dm, REG_TX_IQK_PI_A, MASKDWORD, 0x8214019f);
	odm_set_bb_reg(dm, REG_RX_IQK_PI_A, MASKDWORD, 0x28160200);
			     ...
			     boolean is2T)
{
	...
	odm_set_bb_reg(dm, REG_FPGA0_XCD_RF_INTERFACE_SW, MASKDWORD, 0x25204200);
