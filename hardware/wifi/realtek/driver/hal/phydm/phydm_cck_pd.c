	...
	void *dm_void)
{
	...
	if (igi_curr > 0x38 && dm->rssi_min > 32) {
		pd_th_20m_1r = dig_t->cck_pd_20m_1r + BASE_92F + STEP_92F * 2;
		pd_th_40m_1r = dig_t->cck_pd_40m_1r + BASE_92F + STEP_92F * 2;
		cs_ratio_20m_1r = dig_t->cck_cs_ratio_20m_1r +
				  BASE_92F + STEP_92F * 2;
		cs_ratio_40m_1r = dig_t->cck_cs_ratio_40m_1r +
				  BASE_92F + STEP_92F * 2;
	} else if ((igi_curr > 0x2a) && (dm->rssi_min > 32)) {
		pd_th_20m_1r = dig_t->cck_pd_20m_1r + BASE_92F + STEP_92F;
		pd_th_40m_1r = dig_t->cck_pd_40m_1r + BASE_92F + STEP_92F;
		cs_ratio_20m_1r = dig_t->cck_cs_ratio_20m_1r +
				  BASE_92F + STEP_92F;
		cs_ratio_40m_1r = dig_t->cck_cs_ratio_40m_1r +
				  BASE_92F + STEP_92F;
		   ...
		   (dm->rssi_min > 24 && dm->rssi_min <= 30)) {
		pd_th_20m_1r = dig_t->cck_pd_20m_1r + BASE_92F;
		pd_th_40m_1r = dig_t->cck_pd_40m_1r + BASE_92F;
		cs_ratio_20m_1r = dig_t->cck_cs_ratio_20m_1r + BASE_92F;
		cs_ratio_40m_1r = dig_t->cck_cs_ratio_40m_1r + BASE_92F;

	} else if ((igi_curr <= 0x24) || (dm->rssi_min < 22)) {
		if (cckpd_t->cck_fa_ma > 1000) {
			pd_th_20m_1r = dig_t->cck_pd_20m_1r + STEP_92F;
			pd_th_40m_1r = dig_t->cck_pd_40m_1r + STEP_92F;
			cs_ratio_20m_1r = dig_t->cck_cs_ratio_20m_1r + STEP_92F;
			cs_ratio_40m_1r = dig_t->cck_cs_ratio_40m_1r + STEP_92F;
		} else if (cckpd_t->cck_fa_ma < 500) {
	...
	void *dm_void)
{
	...
	if (igi_curr > 0x38 && dm->rssi_min > 32) {
		pd_th_20m_2r = dig_t->cck_pd_20m_2r + BASE_92F + STEP_92F * 2;
		pd_th_40m_2r = dig_t->cck_pd_40m_2r + BASE_92F + STEP_92F * 2;
		cs_ratio_20m_2r = dig_t->cck_cs_ratio_20m_2r +
				  BASE_92F + STEP_92F * 2;
		cs_ratio_40m_2r = dig_t->cck_cs_ratio_40m_2r +
				  BASE_92F + STEP_92F * 2;
	} else if ((igi_curr > 0x2a) && (dm->rssi_min > 32)) {
		pd_th_20m_2r = dig_t->cck_pd_20m_2r + BASE_92F + STEP_92F;
		pd_th_40m_2r = dig_t->cck_pd_40m_2r + BASE_92F + STEP_92F;
		cs_ratio_20m_2r = dig_t->cck_cs_ratio_20m_2r +
				  BASE_92F + STEP_92F;
		cs_ratio_40m_2r = dig_t->cck_cs_ratio_40m_2r +
				  BASE_92F + STEP_92F;
		   ...
		   (dm->rssi_min > 24 && dm->rssi_min <= 30)) {
		pd_th_20m_2r = dig_t->cck_pd_20m_2r + BASE_92F;
		pd_th_40m_2r = dig_t->cck_pd_40m_2r + BASE_92F;
		cs_ratio_20m_2r = dig_t->cck_cs_ratio_20m_2r + BASE_92F;
		cs_ratio_40m_2r = dig_t->cck_cs_ratio_40m_2r + BASE_92F;
	} else if ((igi_curr <= 0x24) || (dm->rssi_min < 22)) {
		if (cckpd_t->cck_fa_ma > 1000) {
			pd_th_20m_2r = dig_t->cck_pd_20m_2r + STEP_92F;
			pd_th_40m_2r = dig_t->cck_pd_40m_2r + STEP_92F;
			cs_ratio_20m_2r = dig_t->cck_cs_ratio_20m_2r + STEP_92F;
			cs_ratio_40m_2r = dig_t->cck_cs_ratio_40m_2r + STEP_92F;
		} else if (cckpd_t->cck_fa_ma < 500) {
